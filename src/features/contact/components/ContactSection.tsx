      ...
      <div className="relative z-10 w-full min-h-full flex flex-col md:flex-row">
        ...
        ">
          <div className={`chan-col ${cls}`}>
            <a className="chan ch-linkedin" href={process.env.NEXT_PUBLIC_LINKEDIN_URL} target="_blank" rel="noopener noreferrer">
            ...
            <a className="chan ch-github" href={process.env.NEXT_PUBLIC_GITHUB_URL} target="_blank" rel="noopener noreferrer">
            ...
            <a className="chan ch-email" href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL}`} target="_blank" rel="noopener noreferrer">
      ...
      >
        <div className="modal" style={{ maxWidth: 990, height: '90vh' }} role="dialog" aria-modal="true" aria-label="Dossier">
          ...
          <div className="modal-hdr">
            ...
            <div className="modal-hdr-r">
              <span className="modal-status" aria-hidden="true"><i />Online</span>
      ...
      >
        <div className="modal" style={{ maxWidth: 560 }} role="dialog" aria-modal="true" aria-label="Transmit a contract">
          ...
          <div className="modal-hdr">
            ...
            <div className="modal-hdr-r">
              <span className="modal-status" aria-hidden="true"><i />Secure</span>
              <button className="modal-close" onClick={() => setActiveModal(null)}>
                <svg viewBox="0 0 10 10" aria-hidden="true"><line x1="1" y1="1" x2="9" y2="9"/><line x1="9" y1="1" x2="1" y2="9"/></svg>
                ESC
              </button>
          ...
          <div className="modal-body">
            <div className="form-inner">
              <h3 className="form-title">Transmit a Contract</h3>
