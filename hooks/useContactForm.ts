...
import { validateField, type ContactFormField } from '@/schemas/validateContactInput';

// ── Types ──────────────────────────────────────────────────────────────────────

export type Fields = { name: string; email: string; contractType: string; message: string; org: string };
export type Errors = Record<ContactFormField, string>;
...
const EMPTY_FIELDS: Fields = { name: '', email: '', contractType: 'Other', message: '', org: '' };
const EMPTY_ERRORS: Errors = { name: '', email: '', message: '', org: '' };
